этот репозиторий был создан для моего друга Ромы, чтоб пояснить ему что и куда паять, если вы про и знаете, что такое конденсатор, можете не читать эту часть README.
